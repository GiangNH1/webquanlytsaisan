...
<style type="text/css">
	...
	<?php
		include("ketnoi2.php");
		$roomid=$_GET["roomid"];
		$sql = "select * from tools where roomid = '$roomid'";
...
<body class="cbp-spmenu-push">
			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="bordered-table"> 
						<h4>Danh sách tài sản phòng <?php echo $roomid ?>:</h4>
						<form action="edit_deleteTools.php" id="form0" method="get" name="frmList">
						<table class="table table-bordered"> 
							<thead> 
								...
								<tbody> 
								    ...
								    ?>
									<tr> 
										<td><input type="checkbox" id="toolid" name="toolid" value="<?php echo $rs["toolid"] ?>">
											<input type="hidden" name="roomid" value="<?php echo $roomid ?>">
										</td>
										<td><?php echo $rs["toolid"]?></td> 
										<td><?php echo $rs["toolname"]?></td> 
										<td><?php echo $rs["amount"]?></td>
										<td><a href="detailTool.php?roomid=<?php echo $rs["roomid"]?>">Xem chi tiết</a> </td>
									</tr>
									<?php 
										}
									?> 
	...
	function check(){
		if(document.getElementById('toolid').checked == false){
