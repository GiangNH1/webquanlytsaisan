			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="bordered-table"> 
						<h4>danh sánh phòng thực hành</h4>
						<table class="table table-bordered"> 
							...
							<tbody> 
								...
								<tr> 
									...
									<td><a href="listTool.php?roomid=<?php echo $rs["roomid"]?>"><?php echo $rs["roomid"]?></a></td> 
									<td><?php echo $rs["roomname"]?></td> 
									<td><?php echo $rs["location"]?></td>
									<td><a href="listTool.php?roomid=<?php echo $rs["roomid"]?>">Xem </a> </td>
								</tr>
								<?php 
									}
								?> 
...
<?php
  ...
  session_destroy();
  echo("<script > alert('Báº¡n khÃ´ng Ä‘á»§ quyá»�n truy cáº­p vÃ o trang nÃ y!');
