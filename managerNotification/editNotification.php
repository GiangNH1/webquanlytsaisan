...
<style type="text/css">
	...
	<?php
		...
		if(isset($_POST["edit"])){
			...
			$sql="update notification set contents='$contents' where notificationid = '$notificationid'";
			mysqli_query($link,$sql);
			echo("<script > alert('Sửa thông tin thành công!');
				window.location='listNotification.php';
				</script>");
	    }else{
	...
	<!-- end menu -->
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<div class="row">
						<h3 class="title1">sửa thông báo :</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" action="" method="post" >
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Mã thông báo: </label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="notificationid" disabled="disabled" value="<?php echo $notificationid ?>">
										<input type="hidden" value="<?php echo $notificationid ?>" name="notificationid">
									</div>
									<div class="col-sm-2">
