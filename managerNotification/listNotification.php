...
<style type="text/css">
	...
	<?php
		include("ketnoi2.php");
		$sql = "select * from notification where sender ='$user' ";
...
<body class="cbp-spmenu-push">
	...
	<!-- end menu -->
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h2 class="title1" style="text-align: center;">Danh sách thông báo </h2>
						...
						<table class="table table-bordered"> 
							...
							<tbody> 
								...
								<tr> 
									...
									<td><?php echo $rs["sendate"]?></td>
									<td><a href="editNotification.php?notificationid=<?php echo $rs["notificationid"]?>">Chỉnh sửa</a> </td>
									<td><a onclick="return ConfirmXoa()" href="deleteNotification.php?notificationid=<?php echo $rs["notificationid"]?>">Xóa </a> </td>
								</tr>
								<?php 
									}
								?> 
