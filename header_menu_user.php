	...
	<!-- Collect the nav links, forms, and other content for toggling -->
		<div class="collapse navbar-collapse navbar-ex1-collapse navbar-right">
			<ul class="nav navbar-nav">
				<li class="menuli"><a href="register/information.php">Đăng kí phòng thực hành</a></li>
				<li class="menuli"><a href="register/TKBPractice.php">Thời khóa biểu thực hành</a></li>
				<li class="menuli"><a href="personalPage_user.php">Thông tin cá nhân</a></li>
				<li class="drop-down menuli">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">User name<b class="caret"></b></a>
					<ul class="dropdown-menu">
						<li><a href="#"> Cài đặt</a></li>
						<li><a href="changePassword_user.php"> Thay đổi mật khẩu</a></li>
