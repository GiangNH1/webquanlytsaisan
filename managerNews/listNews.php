...
<body class="cbp-spmenu-push">
	...
	<!-- end menu -->
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h2 class="title1" style="text-align: center;">Danh sách tin tức </h2>
					<div class="bs-example widget-shadow" data-example-id="bordered-table"> 
						<table class="table table-bordered"> 
							...
							<tbody> 
								...
								<tr> 
									...
									<td><a href="editNews.php?newsid=<?php echo $rs["newsid"]?>">Chỉnh sửa</a> </td>
									<td><a onclick="return ConfirmXoa()" href="deleteNews.php?newsid=<?php echo $rs["newsid"]?>">Xóa tin</a> </td>
								</tr>
								<?php 
									}
								?> 
						...
						<a href="createNews.php">Thêm mới</a>
					</div>
