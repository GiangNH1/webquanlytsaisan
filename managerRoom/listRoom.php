			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="bordered-table"> 
						<h4>Danh sách phòng thực hành:</h4>
					<form action="edit_deleteRoom.php" id="form0" method="get" name="frmList">
						<table class="table table-bordered"> 
							...
							<tbody> 
							    ...
							    ?>
								<tr> 
									<td><input type="checkbox" id="roomid" name="roomid" value="<?php echo $rs["roomid"] ?>"></td>
									<td><a href="../managerAsset/listAsset.php?roomid=<?php echo $rs["roomid"]?>"><?php echo $rs["roomid"]?></a></td> 
									<td><?php echo $rs["roomname"]?></td> 
									<td><?php echo $rs["location"]?></td>
									<td><a href="../managerAsset/listAsset.php?roomid=<?php echo $rs["roomid"]?>">Xem chi tiết</a> </td>
								</tr>
								<?php 
									}
								?> 
