						...
						<div class="form-three widget-shadow">
							...
							<form class="form-horizontal" action="" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
									<input required="required" type="date" class="form-control" id="datestart" name="datestart" value="<?php echo $datestart ?>" />
...
?>
    ...
    var patt = new RegExp("^2020-06-2[2-8]{1}");
    if(!(patt.test(customerId))){
        notification.innerHTML="Xin lỗi, bạn chỉ được đăng ký TUẦN 1 từ ngày 22/06/2020 đến 28/06/2020";
...
document.getElementById("datestart").addEventListener("change",validateDate);
