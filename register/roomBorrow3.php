...
?>
    ...
    var patt1 = new RegExp("^2020-07-1[5-9]{1}|2[0-1]{1}");
    var patt = new RegExp("^2020-07-0[6-9]{1}|1[0-2]{1}");
    if(!(patt.test(customerId))){
        notification.innerHTML="Xin lỗi, bạn chỉ được đăng ký TUẦN 3 từ ngày 06/07/2020 đến 12/07/2020";
