...
<body class="cbp-spmenu-push">
	...
	<div class="container">
			<div class="main-page">
				<div class="tables">
					<h2 class="title1" style="text-align: center;">Các phòng thực hành đã đăng ký</h2>
							...
							<thead> 
								...
								<tbody> 
									...
									<tr> 
										...
										<td><?php echo $rs["dateregist"]; ?></td>
										<td><?php echo $rs["datestart"];?></td>
										<td><?php echo $rs["daystart"];?></td>
										<td><?php echo $rs["formlesson"]; echo "-"; echo  $rs["tolesson"] ?></td>
