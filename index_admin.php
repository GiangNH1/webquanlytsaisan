				...
				<div class="activity_box activity_box2">
					...
					<div class="scrollbar" id="style-2">
						<div class="activity-row activity-row1">
							...
							?>
								<li>
									<a href="chat_admin.php?username=<?php echo $rs['username'] ?>">
										<div class="chat-left">
										<img class="img-circle" src="images/user.jpg" width="34px" height="34px" alt="">
											<label class="small-badge bg-green"></label>
										</div>
										<div class="chat-right">
											<label><?php echo $rs["fullname"]; ?></label>
											<h6>online</h6>
