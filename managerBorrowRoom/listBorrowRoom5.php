	...
	<!-- end menu -->
		...
		<div id="page-wrapper">
			<div class="main-page">
                    ...
                    <p style="text-align: center;">Tuần 1: Từ ngày 01/07/2020 đến ngày 07/07/2020</p>
						...
						<table class="table table-bordered" style="border: 1px;"> 
							<tdead> 
								<tr> 
									...
									<td colspan="2" style="text-align: center;"><b>2</b></td>
                                ...
                                <tr> 
									...
									<td colspan="2"><b><?php echo $datesql1; ?></b></td>
							...
							<tbody>
									...
									<tr>	
										...
										<tr>
											...
											<td><a class = "btn btn-primary" onclick= "return confirm('Bạn có chắc chắn muốn duyệt thông tin này không?')" href="browserRoom.php?username=<?php echo $rs['username'] ?>&roomid=<?php echo $rs["roomid"]?>&datestart=<?php echo $rs['datestart'] ?>&daystart=<?php echo $rs['daystart'] ?>">Duyệt </a></td>
										<?php } ?>
											<?php 
